...
/* harmony import */ var _pois__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pois */ "./src/pois/index.js");
...
protectedApiRouter.use('/poi', _pois__WEBPACK_IMPORTED_MODULE_6__["router"].routes());
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./router */ "./src/pois/router.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "router", function() { return _router__WEBPACK_IMPORTED_MODULE_0__["router"]; });
...
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! koa-router */ "koa-router");
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(koa_router__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./store */ "./src/pois/store.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils */ "./src/utils/index.js");



const router = new koa_router__WEBPACK_IMPORTED_MODULE_0___default.a(); // let lastUpdated = getLastUpdated();
//
...
router.get('/:id', async ctx => {
  const userId = ctx.state.user._id;
  const poi = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].findOne({
    _id: ctx.params.id
  });
  const response = ctx.response;
...
const createPoi = async (ctx, poi, response) => {
  try {
    const userId = ctx.state.user._id;
    poi.userId = userId;
    response.body = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].insert(poi);
    response.status = 201; // created
...
/*!***************************!*\
  !*** ./src/pois/store.js ***!
  \***************************/
/*! exports provided: PoiStore, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PoiStore", function() { return PoiStore; });
/* harmony import */ var nedb_promise__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! nedb-promise */ "nedb-promise");
/* harmony import */ var nedb_promise__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(nedb_promise__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony default export */ __webpack_exports__["default"] = (new PoiStore({
  filename: './db/pois.json',
  autoload: true
}));
...
module.exports = __webpack_require__(/*! /Users/danielgogozan/Desktop/journey-server/src/index.js */"./src/index.js");
